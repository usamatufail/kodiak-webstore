...
export const Navigation = () => {
  return (
    <div className="grid grid-cols-2 h-[150px] gap-[4px] mt-[45px]">
      <CustomLink
        link="#hunting-knives"
        img="https://res.cloudinary.com/samtufail726/image/upload/f_auto/v1675474860/kodiak/Blades/DSC02380_aprq6x.jpg"
        text="Hunting Knives"
      />
      <CustomLink
        link="#handmade-knives"
        img="https://res.cloudinary.com/samtufail726/image/upload/f_auto/v1675474903/kodiak/Blades/DSC03679-Edit_a4xfoe.webp"
