  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="md:hidden text-white text-[44px] font-bold leading-[1.11] text-center mb-[4px] pt-[20px]">
          Follow us on social
        </h2>
        <p className="text-white text-[16px] md:text-[18px] text-center md:text-left mb-[30px]">
          ...
          content from Kodiak F.A.S.T Company, your trusted source for
          high-quality, rugged F.A.S.T.
        </p>
