...
export const ShopCards = ({ data = allData }: { data: any }) => {
  return (
    <div
      className="px-[12px] md:px-[280px] flex flex-col gap-[45px] mb-[4px] mt-[4px] py-[45px] bg-cover bg-no-repeat overflow-hidden relative md:grid md:grid-cols-2 md:gap-[45px]"
      style={{
        backgroundImage:
