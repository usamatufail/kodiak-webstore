      ...
      <ShopifyProvider countryCode={countryCode}>
        <Seo
          ...
          data={{
            ...
            description: `At Kodiak F.A.S.T. Company, we aim to craft handmade Alaskan knives that inspire adventure and exceed expectations. As outdoor enthusiasts, we understand the importance of having a durable, reliable, and functional knife.`,
            titleTemplate: `%s`,
          }}
        />
        <CartProvider
