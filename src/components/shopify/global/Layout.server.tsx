 ...
 */
export function ShopifyLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
...
const SHOP_QUERY = gql`
  ...
  query layoutMenus($language: LanguageCode, $headerMenuHandle: String!, $footerMenuHandle: String!) @inContext(language: $language) {
    shop {
      name
    }
